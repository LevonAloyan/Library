...
public class UnassignedBookServlet extends GenericServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/unAssign.jsp").forward(req, resp);
    }

    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        int selectedBook = Integer.parseInt(req.getParameter("bookId"));
        ...
        if (book != null) {
            ...
            req.getRequestDispatcher("/unAssign.jsp").include(req, resp);
        }
    }
}